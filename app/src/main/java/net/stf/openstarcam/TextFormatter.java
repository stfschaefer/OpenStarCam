...
public class TextFormatter {
     ...
     */
    public String getGPSString(String preference_stamp_gpsformat, String preference_units_distance, boolean store_location, Location location, boolean store_geo_direction, double geo_direction, double geo_pitch) {
        String gps_stamp = "";
        if( !preference_stamp_gpsformat.equals("preference_stamp_gpsformat_none") ) {
            ...
            if( store_geo_direction ) {
                ...
                if( MyDebug.LOG )
                    Log.d(TAG, String.format("geo_angle: %1.0f/%1.0f",geo_angle,geo_pitch));
                if( gps_stamp.length() > 0 )
                    gps_stamp += ", ";
                gps_stamp += String.format("%1.0f/%1.0f",geo_angle,geo_pitch);
