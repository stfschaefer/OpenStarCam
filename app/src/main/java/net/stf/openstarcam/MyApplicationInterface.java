...
import net.stf.openstarcam.preview.BasicApplicationInterface;
import net.stf.openstarcam.preview.Preview;
import net.stf.openstarcam.preview.VideoProfile;
import net.stf.openstarcam.ui.DrawPreview;
...
public class MyApplicationInterface extends BasicApplicationInterface {
    ...
    //private final float text_x, text_y, gap_x, gap_y, offset_y;
        ...
        if( dategeo_subtitles && video_method != ApplicationInterface.VideoMethod.URI ) {
            ...
            class SubtitleVideoTimerTask extends TimerTask {
                ...
                public void run() {
                    ...
                    String gps_stamp = main_activity.getTextFormatter().getGPSString(
                            preference_stamp_gpsformat,
                            preference_units_distance,
                            store_location && location!=null,
                            location,
                            store_geo_direction && main_activity.getPreview().hasGeoDirection(),
                            geo_direction,
                            main_activity.getPreview().getPitchAngle()
                    );
                    if( MyDebug.LOG ) {
                    ...
                    if( gps_stamp.length() > 0 ) {
                        ...
                        if( address == null || preference_stamp_geo_address.equals("preference_stamp_geo_address_both") ) {
                            ...
                            gps_stamp = main_activity.getTextFormatter().getGPSString(
                                    preference_stamp_gpsformat,
                                    preference_units_distance,
                                    false,
                                    null,
    ...
    void DrawTriangle(Canvas canvas, Paint paint, float b, float h, float x, float y, float angle) {
        ...
        path.moveTo(-b*0.5f, 0.0f);
        path.lineTo(b*0.5f, 0.0f);
        path.lineTo(0f, h);
        path.moveTo(x, y);
    ...
    void DrawUIText(Canvas canvas, Paint paint, String s, Color tColor, Color bColor, Paint.Style style) {
