...
import net.stf.openstarcam.remotecontrol.BluetoothRemoteControl;
import net.stf.openstarcam.ui.FolderChooserDialog;
import net.stf.openstarcam.ui.MainUI;
import net.stf.openstarcam.ui.ManualSeekbars;
...
public class MainActivity extends Activity {
    ...
    static private final String ACTION_SHORTCUT_CAMERA = "net.stf.opencamera.SHORTCUT_CAMERA";
    static private final String ACTION_SHORTCUT_SELFIE = "net.stf.opencamera.SHORTCUT_SELFIE";
    static private final String ACTION_SHORTCUT_VIDEO = "net.stf.opencamera.SHORTCUT_VIDEO";
    static private final String ACTION_SHORTCUT_GALLERY = "net.stf.opencamera.SHORTCUT_GALLERY";
    static private final String ACTION_SHORTCUT_SETTINGS = "net.stf.opencamera.SHORTCUT_SETTINGS";
